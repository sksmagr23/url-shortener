...
func main() {
	...
	app.GET("/urls/{short_code}/versions", urlHandler.ListVersions)
	app.POST("/urls/{short_code}/rollback/{version}", urlHandler.RollbackVersion)
	app.POST("/urls/{short_code}/rollback", urlHandler.RollbackVersion)
