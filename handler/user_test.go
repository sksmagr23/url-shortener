...
func (m *MockUserService) ListAPIKeys(ctx *gofr.Context, userID string) ([]string, error) {
	args := m.Called(ctx, userID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockUserService) RevokeAPIKey(ctx *gofr.Context, userID, apiKey string) error {
